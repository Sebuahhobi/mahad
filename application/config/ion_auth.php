...
$config['super_admin_group']          = 'super_admin'; 
$config['default_super_admin_group']  = 'super_admin';
$config['default_mhs_group']          = 'Mahasiswa';
$config['mhs_group']                  = 'Mahasiswa';
//admin group create
$config['default_admin_group']        = 'admin';
...
$config['user_expire']                = 1800;               // How long to remember the user (seconds). Set to zero for no expiration
