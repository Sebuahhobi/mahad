<div class="">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Tambah kamar ikhwan<small></small></h2>
	    ...
	    <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="char">Kamar <?php echo form_error('kamar') ?></label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" class="form-control" name="kamar" id="kamar" placeholder="kamar" value="<?php echo $kamar; ?>" />
                </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
        	    ...
        	    <a href="<?php echo site_url('super_admin/list_kamar_ikhwan') ?>" class="btn btn-default"><i class="fa fa-reply-all"></i> Cancel</a>
	       </div>
        </div>
    </form>
</div>
