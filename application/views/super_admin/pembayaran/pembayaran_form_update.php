<div class="">
    ...
    <div class="row">
                    ...
                    <script type="text/javascript">
                        ...
                        $(function(){
                            ...
                            if(respond>0){
                                    ...
                                    $("#jumlah_pembayaran").val(output2);           //attr("placeholder", output2);
	    ...
	    <button type="submit" class="btn btn-primary" id="save" name="save"><i class="fa fa-floppy-o"></i> <?php echo $button ?></button> 
