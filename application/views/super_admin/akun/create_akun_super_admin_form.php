<div class="">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Buat akun super admin<small>&MediumSpace;</small></h2>
                ...
                <div class="x_content">
                    <br>
        <?php echo form_open("super_admin/create_akun_super_admin", 'data-parsley-validate="" class="form-horizontal form-label-left" novalidate=""');?>
      ...
      ?>
	    ...
	    <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="char">Email <?php echo form_error('email') ?></label>
            <div class="col-md-6 col-sm-6 col-xs-12">
