<div class="">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Buat akun admin<small>&MediumSpace;</small></h2>
                ...
                <div class="x_content">
                    <br>
        <?php echo form_open("super_admin/create_akun_admin", 'data-parsley-validate="" class="form-horizontal form-label-left" novalidate=""');?>
