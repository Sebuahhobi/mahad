...
class Ion_auth
{
        ...
        public function __call($method, $arguments)
	{
		...
		if($method == 'create_user')
		{
			return call_user_func_array(array($this, 'register_admin'), $arguments);
		}
		if($method=='update_user')
		{
			return call_user_func_array(array($this, 'update'), $arguments);
	...
	/*public function register($identity, $password, $email, $additional_data = array(), $group_ids = array()) //need to test email activation
	{
        ...
        public function register_super_admin($identity, $password, $email, $additional_data = array(), $group_ids = array()) //need to test email activation
	{
		$this->ion_auth_model->trigger_events('pre_account_creation');

		$email_activation = $this->config->item('email_activation', 'ion_auth');

		$id = $this->ion_auth_model->register_super_admin($identity, $password, $email, $additional_data, $group_ids);
        ...
        //END Register Super_Admin
        public function register_admin($identity, $password, $email, $additional_data = array(), $group_ids = array()) //need to test email activation
	{
		$this->ion_auth_model->trigger_events('pre_account_creation');

		$email_activation = $this->config->item('email_activation', 'ion_auth');

		$id = $this->ion_auth_model->register_admin($identity, $password, $email, $additional_data, $group_ids);
        ...
        //register mhs
        public function register_mhs($identity, $password, $email, $additional_data = array(), $group_ids = array()) //need to test email activation
	{
		$this->ion_auth_model->trigger_events('pre_account_creation');

		$email_activation = $this->config->item('email_activation', 'ion_auth');

		$id = $this->ion_auth_model->register_mhs($identity, $password, $email, $additional_data, $group_ids);
	 ...
	 **/
        //cek admin
        public function is_mhs($id=false)
	{
		$this->ion_auth_model->trigger_events('is_mhs');

		$mhs_group = $this->config->item('mhs_group', 'ion_auth');

		return $this->in_group($mhs_group, $id);
	}
        //END cek admin
       ...
       public function is_super_admin($id=false)
	{
		...
		$super_admin_group = $this->config->item('super_admin_group', 'ion_auth');

		return $this->in_group($super_admin_group, $id);
	}
